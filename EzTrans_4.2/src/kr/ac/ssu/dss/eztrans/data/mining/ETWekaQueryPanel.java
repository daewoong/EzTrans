...
public class ETWekaQueryPanel 
  ...
  /** the execute button. */
  protected JButton m_ButtonExecute = new JButton("실행");

  /** the clear button. */
  protected JButton m_ButtonClear = new JButton("지움");
   ...
   */
  public ETWekaQueryPanel(JFrame parent) {
    super();
