 ...
 */
public class ETWekaSqlViewerDialog 
  extends JDialog 
  ...
  /** the SQL panel */
  protected ETWekaSqlViewer m_Viewer;
   ...
   */
  public ETWekaSqlViewerDialog(JFrame parent) {
  ...
  protected void createDialog() {
    JPanel                    panel;
    JPanel                    panel2;
    final ETWekaSqlViewerDialog     dialog;
    
    dialog = this;
    setLayout(new BorderLayout());

    // sql panel
    m_Viewer = new ETWekaSqlViewer(m_Parent);
  ...
  public static void main(String[] args) {
    ETWekaSqlViewerDialog       dialog;

    dialog = new ETWekaSqlViewerDialog(null);
    dialog.setDefaultCloseOperation(ETWekaSqlViewerDialog.DISPOSE_ON_CLOSE);
