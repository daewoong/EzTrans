 ...
 */
public class ETWekaAssociationsPanel 
  extends JPanel
   ...
   */
  public ETWekaAssociationsPanel() {
    ...
    m_AssociatorEditor.setValue(ETWekaExplorerDefaults.getAssociator());
  ...
  public static void main(String [] args) {
	...
	new javax.swing.JFrame(Messages.getInstance().getString("AssociationsPanel_Main_JFrame_Text"));
      ...
      final ETWekaAssociationsPanel sp = new ETWekaAssociationsPanel();
