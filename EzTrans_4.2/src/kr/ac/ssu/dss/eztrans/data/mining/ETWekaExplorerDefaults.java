 ...
 * @see #PROPERTY_FILE
 */
public class ETWekaExplorerDefaults
implements Serializable {
	...
	public final static String PROPERTY_FILE = "Explorer.props";
	...
	public static String[] getTabs() {
		...
		tabs   = get("Tabs", "kr.ac.ssu.dss.eztrans.data.mining.ETWekaClassifierPanel,kr.ac.ssu.dss.eztrans.data.mining.ETWekaClustererPanel,kr.ac.ssu.dss.eztrans.data.mining.ETWekaAssociationsPanel,kr.ac.ssu.dss.eztrans.data.mining.ETWekaAttributeSelectionPanel,kr.ac.ssu.dss.eztrans.data.mining.ETWekaVisualizePanel");
		result = tabs.split(",");
