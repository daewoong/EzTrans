 ...
 */
public class ETWekaResultPanel 
  extends JPanel 
  ...
  /** the close button */
  protected JButton m_ButtonClose = new JButton("닫기");

  /** the close all button */
  protected JButton m_ButtonCloseAll = new JButton("모두 닫기");
  ...
  protected JButton m_ButtonOptWidth = new JButton("너비 조절");
   ...
   */
  public ETWekaResultPanel(JFrame parent) {
    super();
  ...
  protected void createPanel() {
    ...
    m_ButtonOptWidth.setToolTipText("현재 테이블의 적절한 너비를 계산합니다");
   ...
   */
  public ETWekaQueryPanel getQueryPanel() {
    return m_QueryPanel;
  }
   ...
   */
  public void setQueryPanel(ETWekaQueryPanel panel) {
    m_QueryPanel = panel;
  }
