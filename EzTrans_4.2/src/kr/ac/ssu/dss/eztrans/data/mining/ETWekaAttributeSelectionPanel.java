 ...
 */
public class ETWekaAttributeSelectionPanel 
  extends JPanel
 ...
 /** Stop the class combo from taking up to much space */
   ...
   */
  public ETWekaAttributeSelectionPanel() {
    ...
    m_AttributeEvaluatorEditor.setValue(ETWekaExplorerDefaults.getASEvaluator());
    ...
    m_AttributeSearchEditor.setValue(ETWekaExplorerDefaults.getASSearch());
    ...
    m_TrainBut.setSelected(ETWekaExplorerDefaults.getASTestMode() == 0);
    m_CVBut.setSelected(ETWekaExplorerDefaults.getASTestMode() == 1);
    updateRadioLinks();
    ...
    m_CVText.setText("" + ETWekaExplorerDefaults.getASCrossvalidationFolds());
    m_SeedText.setText("" + ETWekaExplorerDefaults.getASRandomSeed());
  ...
  public static void main(String [] args) {
	...
	new javax.swing.JFrame(Messages.getInstance().getString("AttributeSelectionPanel_Main_JFrame_Text"));
      jf.getContentPane().setLayout(new BorderLayout());
      final ETWekaAttributeSelectionPanel sp = new ETWekaAttributeSelectionPanel();
